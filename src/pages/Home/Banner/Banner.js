            ...
            <div className="container bg-color-sm text-center">
                <div className='row align-items-center'>
                    <div className="col-12 col-md-6 col-lg-6 text-light text-start">
                        ...
                        <Link to="/donation"><button className="btn button-color rounded-pill text-light px-4 py-2">Donate Now <span className='ms-2'><BsArrowUpRightCircle /></span></button></Link>
                    </div>
